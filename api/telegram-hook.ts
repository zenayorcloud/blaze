...
export async function handleStartCommand(ctx) {
  const COMMAND = "/start";
  const channelUrl = "t.me/fastproxyys";
  const targetUrl = "t.me/+FfdKvBH_iwkwYzkx";
  ...
  const media = [
    {
      type: "photo",
      media:
        "https://raw.githubusercontent.com/zenayorcloud/blaze/main/WhatsApp%20Image%202025-10-31%20at%2021.32.00_076375b4.jpg",
    },
    {
      type: "photo",
      media:
        "https://raw.githubusercontent.com/zenayorcloud/blaze/main/WhatsApp%20Image%202025-10-31%20at%2021.32.00_2d0bb784.jpg",
    },
    {
      type: "photo",
      media:
        "https://raw.githubusercontent.com/zenayorcloud/blaze/main/WhatsApp%20Image%202025-10-31%20at%2021.32.00_5f62554b.jpg",
    },
    {
      type: "photo",
      media:
        "https://raw.githubusercontent.com/zenayorcloud/blaze/main/WhatsApp Image 2025-10-31 at 21.32.01_0252194e.jpg",
    },
